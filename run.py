...
def main():
    ...
    p.add_argument("--out", required=True)
    p.add_argument("--abaqus-command", help="Explicit Abaqus launcher; default order: environment.local.json abaqus_launcher -> PATH abaqus -> PATH abq2026. A release gate (abaqus_release_required, default template: 2026) is enforced before any attempt is created; wrong/unknown versions raise ABAQUS_RELEASE_MISMATCH")
